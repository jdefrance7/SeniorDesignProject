/**
 *  @file wing_segment_config_2.h
 *
 *  Configuration file for wing segment orientation system with identifier 2.
 *
...
#define WING_SEGMENT                  (2)

//******************************************************************************
// Node Information

#define NODE_ID                       (22)
#define NODE_NAME                     ("2.winglet.uavcan")
