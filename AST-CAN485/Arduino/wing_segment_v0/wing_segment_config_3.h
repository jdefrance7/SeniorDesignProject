/**
 *  @file wing_segment_config_3.h
 *
 *  Configuration file for wing segment orientation system with identifier 3.
 *
 *  Values in parentheses are variable settings.
 *
 *  Items without parentheses are build configurations
 *
 *  @author Joe DeFrance
 */
...
#define WING_SEGMENT                  (3)

//******************************************************************************
// Node Information

#define NODE_ID                       (23)
#define NODE_NAME                     ("3.winglet.uavcan")
